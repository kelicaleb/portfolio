  ...
  return (
    ...
    >
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            <div className="glass-card p-8 md:p-12">
              <p className="text-cyan-500 dark:text-cyan-400 font-semibold mb-2 tracking-wide uppercase text-sm">
                Welcome to my portfolio
              </p>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
                Hi, I&apos;m{" "}
                <span className="text-gradient">Caleb</span>
              </h1>
              ...
              <p className="text-slate-500 dark:text-slate-400 text-lg mb-8 max-w-xl">
                Building innovative solutions with Next.js, Python, and modern
                technologies. Currently working as a Software Developer at{" "}
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <a
                  href="#contact"
                  className="glass-button bg-gradient-to-r from-cyan-500 to-teal-500 text-white border-none px-8 py-3 rounded-xl font-semibold hover:shadow-lg hover:shadow-cyan-500/25 transition-all"
                >
                  Get in Touch
                </a>
                <a
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
        <a href="#about" className="text-slate-400 hover:text-cyan-500 transition-colors">
          <svg
            className="w-8 h-8"
            fill="none"
            stroke="currentColor"
